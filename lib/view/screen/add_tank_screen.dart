...
class AddTankScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar:
          Provider.of<TankProvider>(context).allTanks.isNotEmpty
              ? Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text(
                        "* Please add all required tanks before proceeding further",
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDialog(
            context: context,
            builder: (BuildContext context) => const AddTankPopUp(
              editTank: false,
            ),
          );
        },
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(
                              "Max Capacity: ${provider.allTanks[index].totalCapacity} m³"),
                          Text(
                              "Initial Rob: ${provider.allTanks[index].currentROB} m³"),
                          Text(
                              "Tank Type: ${provider.allTanks[index].tankType}"),
                        ],
                      ),
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          GestureDetector(
                            ...
                            onTap: () {
                              showDialog(
                                context: context,
                                builder: (BuildContext context) => AddTankPopUp(
                                  editTank: true,
                                  tankDataToEdit: provider.allTanks[index],
                                ),
                              );
                            },
                          ),
                          ...
                          GestureDetector(
                            ...
                            onTap: () {
                              provider.deleteTank(
                                  tankId: provider.allTanks[index].tankId);
                            },
                          ),
                        ],
                      ),
